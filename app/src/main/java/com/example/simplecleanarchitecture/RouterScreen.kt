...
object RouterScreen {
    ...
    data class UserEditScreen(val id: String?) :
        FragmentScreen(fragmentCreator = { UserEditFragment.newInstance(id) })

    data class UserPasswordChangeScreen(val id: String?) :
        FragmentScreen(fragmentCreator = { UserPasswordChangeFragment.newInstance(id) })
}
